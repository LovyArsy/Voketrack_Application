        ...
        <div class="container-fluid px-3">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav me-auto">
                    <li class="nav-item">
                        <a class="nav-link active" aria-current="page" href="/scans">Scan</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="/barangsiswa">Daftar Barang</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="/peminjamsiswa">Peminjaman</a>
                    </li>
                    <li class="nav-item">
